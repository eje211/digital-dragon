...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ParentProfile.user'
        db.delete_column(u'dragon_portal_parentprofile', 'user_id')

        # Deleting field 'StudentProfile.user'
        db.delete_column(u'dragon_portal_studentprofile', 'user_id')
    ...
    def backwards(self, orm):
        # Adding field 'ParentProfile.user'
        db.add_column(u'dragon_portal_parentprofile', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['dragon_portal.DragonUser'], unique=True, null=True),
                      keep_default=False)

        # Adding field 'StudentProfile.user'
        db.add_column(u'dragon_portal_studentprofile', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['dragon_portal.DragonUser'], unique=True, null=True),
                      keep_default=False)
