...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'User'
        db.create_table(u'dd_portal_user', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'dd_portal', ['User'])

        # Adding M2M table for field groups on 'User'
        m2m_table_name = db.shorten_name(u'dd_portal_user_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'dd_portal.user'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['user_id', 'group_id'])

        # Adding M2M table for field user_permissions on 'User'
        m2m_table_name = db.shorten_name(u'dd_portal_user_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'dd_portal.user'], null=False)),
        ...
        db.create_table(u'dd_portal_parentprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['dd_portal.User'], unique=True, null=True)),
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'User'
        db.delete_table(u'dd_portal_user')

        # Removing M2M table for field groups on 'User'
        db.delete_table(db.shorten_name(u'dd_portal_user_groups'))

        # Removing M2M table for field user_permissions on 'User'
        db.delete_table(db.shorten_name(u'dd_portal_user_user_permissions'))
    ...
    models = {
        ...
        u'dd_portal.parentprofile': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['dd_portal.User']", 'unique': 'True', 'null': 'True'})
        },
