...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dd_portal_studentprofile', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['dd_portal.DragonUser'], unique=True, null=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dd_portal.ParentProfile'], null=True)),
        ...
        db.create_table(u'dd_portal_dragonuser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('type', self.gf('django.db.models.fields.CharField')(default='admin', max_length=16)),
        ))
        db.send_create_signal(u'dd_portal', ['DragonUser'])

        # Adding M2M table for field groups on 'DragonUser'
        m2m_table_name = db.shorten_name(u'dd_portal_dragonuser_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dragonuser', models.ForeignKey(orm[u'dd_portal.dragonuser'], null=False)),
        ...
        m2m_table_name = db.shorten_name(u'dd_portal_dragonuser_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dragonuser', models.ForeignKey(orm[u'dd_portal.dragonuser'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'dd_portal_dragonuser')

        # Removing M2M table for field groups on 'DragonUser'
        db.delete_table(db.shorten_name(u'dd_portal_dragonuser_groups'))

        # Removing M2M table for field user_permissions on 'DragonUser'
        db.delete_table(db.shorten_name(u'dd_portal_dragonuser_user_permissions'))
    ...
    models = {
        ...
        u'dd_portal.dragonuser': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'default': "'admin'", 'max_length': '16'}),
        ...
        u'dd_portal.parentprofile': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['dd_portal.DragonUser']", 'unique': 'True', 'null': 'True'})
        },
        ...
        u'dd_portal.studentprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dd_portal.ParentProfile']", 'null': 'True'}),
