...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Parent.profile'
        db.add_column(u'dd_portal_parent', 'profile',
    ...
    def backwards(self, orm):
        # Deleting field 'Parent.profile'
        db.delete_column(u'dd_portal_parent', 'profile_id')

        # Adding field 'ParentProfile.parent'
        db.add_column(u'dd_portal_parentprofile', 'parent',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['dd_portal.Parent'], unique=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'dd_portal.parent': {
            ...
            'profile': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['dd_portal.ParentProfile']", 'unique': 'True', 'null': 'True'}),
