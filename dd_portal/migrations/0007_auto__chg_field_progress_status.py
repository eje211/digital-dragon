...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Progress.status'
        db.alter_column(u'dd_portal_progress', 'status', self.gf('django.db.models.fields.CharField')(max_length=16))

    def backwards(self, orm):

        # Changing field 'Progress.status'
        db.alter_column(u'dd_portal_progress', 'status', self.gf('django.db.models.fields.TextField')(max_length=16))
