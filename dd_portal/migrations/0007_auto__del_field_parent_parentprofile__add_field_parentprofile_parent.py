...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Parent.parentprofile'
        db.delete_column(u'dd_portal_parent', 'parentprofile_id')

        # Adding field 'ParentProfile.parent'
        db.add_column(u'dd_portal_parentprofile', 'parent',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['dd_portal.Parent'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Parent.parentprofile'
        db.add_column(u'dd_portal_parent', 'parentprofile',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['dd_portal.ParentProfile'], unique=True, null=True),
                      keep_default=False)

        # Deleting field 'ParentProfile.parent'
        db.delete_column(u'dd_portal_parentprofile', 'parent_id')
    ...
    models = {
        ...
        u'dd_portal.parentprofile': {
            ...
            'parent': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['dd_portal.Parent']", 'unique': 'True', 'null': 'True'})
        },
