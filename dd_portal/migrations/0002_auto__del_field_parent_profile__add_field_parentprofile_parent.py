...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'dd_portal_parent', 'profile',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['dd_portal.ParentProfile'], unique=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'dd_portal.parentprofile': {
            ...
            'parent': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['dd_portal.Parent']", 'unique': 'True'})
        },
